...
const PortfolioList = (props) => {
  ...
  return (
    <div className='portfolio-list bg-dark d-flex flex-wrap justify-content-center'>
      {data.map((entry) => (
        <div
          className='portfolio-item card mb-3 bg-secondary text-white mx-3 my-3'
          key={entry.id}
        >
          {editId === entry.id ? (
            <form onSubmit={handleSaveEntry} className='card-body'>
              ...
              <div className='form-group'>
                ...
                <input
                  type='text'
                  value={editCustomerLink}
                  onChange={(event) => setEditCustomerLink(event.target.value)}
                  className='form-control'
                />
              </div>
              <div className='form-group'>
            ...
            <>
              <div className='portfolio-item-header card-header d-flex justify-content-between'>
